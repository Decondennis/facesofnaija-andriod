...
namespace Facesofnaija.Activities.Articles.Fragment
{
    public class ArticlesReactionComment : Java.Lang.Object, PopupWindow.IOnDismissListener
    {
        ...
        private CommentReplyArticlesClickEventArgs PostData;

        public ArticlesReactionComment(Activity context, string type)
        {
            MainContext = context;
            TypeClass = type;
        }
        ...
        /// </summary>
        public void ClickDialog(CommentReplyArticlesClickEventArgs postData)
        {
            try
            {
                PostData = postData;
            ...
            try
            {
                ...
                switch (AppSettings.PostButton)
                {
                    case PostButtonSystem.ReactionDefault:
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.gif_like).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonOne);
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.gif_love).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonTwo);
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.gif_haha).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonThree);
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.gif_wow).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonFour);
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.gif_sad).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonFive);
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.gif_angry).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonSix);
                        break;
                    case PostButtonSystem.ReactionSubShine:
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.like).Apply(new RequestOptions().FitCenter()).Into(MImgButtonOne);
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.love).Apply(new RequestOptions().FitCenter()).Into(MImgButtonTwo);
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.haha).Apply(new RequestOptions().FitCenter()).Into(MImgButtonThree);
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.wow).Apply(new RequestOptions().FitCenter()).Into(MImgButtonFour);
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.sad).Apply(new RequestOptions().FitCenter()).Into(MImgButtonFive);
                        Glide.With(MainContext?.BaseContext).Load(Resource.Drawable.angry).Apply(new RequestOptions().FitCenter()).Into(MImgButtonSix);
                        break;
                }
        ...
        private void ImgButtonOnClick(ReactionsClickEventArgs e)
        {
            try
            {
                ...
                if (e.React == ReactConstants.Like)
                {
                    ...
                    PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => RequestsAsync.Article.ReactionCommentAsync(PostData.CommentObject.BlogId, PostData.CommentObject.Id, react, reactionType) });
                }
        ...
        public static void SetReactionPack(ArticlesCommentAdapterViewHolder holder, string react)
        {
            try
            {
