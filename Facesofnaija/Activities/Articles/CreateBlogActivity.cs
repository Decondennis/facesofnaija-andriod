...
namespace Facesofnaija.Activities.Articles
{
            ...
            try
            {
                ...
                else
                {
                    switch ((int)Build.VERSION.SdkInt)
                    {
                        ...
                        default:
                            {
                                if (PermissionsController.CheckPermissionStorage() && ContextCompat.CheckSelfPermission(this, Manifest.Permission.Camera) == Permission.Granted)
                                {
                                    LoadWebView();
                                }
                                else
