...
namespace Facesofnaija.Activities.Tabbes.Adapters
{
                    ...
                    case StyleRowMore.Grid:
                        {
                            ...
                            switch (AppSettings.MessengerIntegration)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#F59F00")
                                    });
                                    break;
                            }
                                ...
                                case true:
                                    {
                                        ...
                                        SectionList.Add(new SectionItem
                                        {
                                            ...
                                            IconColor = Color.ParseColor("#927AF7")
                                        });
                                        break;
                                    }
                            }
                            ...
                            switch (AppSettings.ShowPokes)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#E668E8")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowAlbum)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#3773D7")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowMyPhoto)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#DF6160")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowMyVideo)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#F77A7A")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowSavedPost)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#3FA0D7")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowCommunitiesGroups)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#A464F5")
                                    });
                                    break;
                            }

                            switch (AppSettings.ShowCommunities)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        Id = 60,
                                        SectionName = activityContext.GetText(Resource.String.Lbl_Communities),
                                        BadgeCount = 0,
                                        StyleRow = styleRowMore,
                                        IconAsImage = Resource.Drawable.ic_more_groups,
                                        ...
                                        Badgevisibilty = false,
                                        Icon = IonIconsFonts.Apps,
                                        IconColor = Color.ParseColor("#ff4224")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowCommunitiesPages)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#ff1fca")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowMarket)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#7934ff")
                                    });
                                    break;
                            }
                            ...
                            if (AppSettings.ShowBoostedPosts || AppSettings.ShowBoostedPages)
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    IconColor = Color.ParseColor("#3949AB")
                                });
                            ...
                            switch (AppSettings.ShowPopularPosts)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#c31eff")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowEvents)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#00838F")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowNearBy)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#5445FF")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowOffers)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#7D4A72")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowMovies)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        Icon = IonIconsFonts.Film,
                                        IconColor = Color.ParseColor("#B9C900")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowJobs)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        Icon = IonIconsFonts.IosBriefcase,
                                        IconColor = Color.ParseColor("#04DC00")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowCommonThings)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#DA0090")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowMemories)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#D07000")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowFundings)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#0092D0")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowGames)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#E40000")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowInfoCoronaVirus)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#747474")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowLive)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#C1303F")
                                    });
                                    break;
                            }
                            ...
                            switch (AppSettings.ShowAdvertise)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        IconColor = Color.ParseColor("#5541A7")
                                    });
                                    break;
                            }
            ...
            try
            {
                ...
                switch (viewType)
                {
                    case (int)StyleRowMore.Card:
                        {
                            itemView = LayoutInflater.From(parent.Context)?.Inflate(Resource.Layout.Style_MoreSectionCardView, parent, false);
                            var vh = new MoreSectionAdapterViewHolder(itemView, Click);
                            return vh;
                        }
                    case (int)StyleRowMore.Grid:
                        {
                            itemView = LayoutInflater.From(parent.Context)?.Inflate(Resource.Layout.Style_MoreSectionGridView, parent, false);
                            var vh = new MoreSectionGridAdapterViewHolder(itemView, Click);
                            return vh;
                        }
                    case (int)StyleRowMore.Row:
                        {
                            itemView = LayoutInflater.From(parent.Context)?.Inflate(Resource.Layout.Style_MoreSectionView, parent, false);
                            var vh = new MoreSectionAdapterViewHolder(itemView, Click);
                            return vh;
                        }
                    default:
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder viewHolder, int position)
        {
            try
            {
                    ...
                    if (viewHolder is MoreSectionAdapterViewHolder holder)
                    {
                        ...
                        if (item.StyleRow == StyleRowMore.Card)
                        {
                            ...
                            if (item.Id == 1)
                            {
                                ...
                                GlideImageLoader.LoadImage(ActivityContext, myProfile != null ? myProfile.Avatar : UserDetails.Avatar, holder.Icon, ImageStyle.CircleCrop, ImagePlaceholders.DrawableUser);
                ...
                else if (item?.StyleRow == StyleRowMore.Grid)
                {
                    ...
                    {
                        holder.Name.Text = item.SectionName;
                        holder.BackIcon.BackgroundTintList = ColorStateList.ValueOf(item.IconColor);
