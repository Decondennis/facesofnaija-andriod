...
namespace Facesofnaija.Activities.Gift.Adapters
{
                            ...
                            if (item != null)
                            {
                                ...
                                switch (getImage)
                                {
                                    case "File Dont Exists":
                                        Glide.With(ActivityContext?.BaseContext).Load(item.MediaFile).Apply(new RequestOptions().Placeholder(Resource.Drawable.ImagePlacholder)).Into(holder.ImgGift);
                                    ...
                                    default:
                                        {
                                            ...
                                            Glide.With(ActivityContext?.BaseContext).Load(photoUri).Apply(new RequestOptions().Placeholder(Resource.Drawable.ImagePlacholder)).Into(holder.ImgGift);
                                            break;
                                        }
                                }
                            }
            ...
            try
            {
                ...
                switch (holder)
                {
                    case GiftAdapterViewHolder viewHolder:
                        Glide.With(ActivityContext?.BaseContext).Clear(viewHolder.ImgGift);
                        break;
                }
