...
using Facesofnaija.Activities.MyPhoto.Adapters;
...
namespace Facesofnaija.Activities.MyPhoto
{
        ...
        private void Download_OnClick()
        {
            try
            {
                ...
                else
                {
                    ...
                    Methods.CapturePhotoUtils.InsertImage(ContentResolver, photos).ConfigureAwait(false);
