...
namespace Facesofnaija.Activities.UsersPages
{
    ...
    public class AllViewerActivity : BaseActivity
    {
        ...
        private FollowingModelClass FollowersModel;
                        ...
                        case "ImagesModel":
                            {
                                switch (MAdapter)
                                {
                                    ...
                                    case ContactsAdapter adapter3:
                                        {
                                            FollowersModel = JsonConvert.DeserializeObject<FollowingModelClass>(item);
                                            if (FollowersModel != null)
                                            {
                                                adapter3.UserList = new ObservableCollection<UserDataObject>(FollowersModel.FollowingList);
