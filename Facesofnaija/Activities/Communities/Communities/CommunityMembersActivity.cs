...
namespace Facesofnaija.Activities.Communities.Communities
{
    ...
    public class CommunityMembersActivity : BaseActivity//, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private void InitComponent()
        {
            try
            {
                ...
                SwipeRefreshLayout.SetProgressBackgroundColorSchemeColor(AppSettings.SetTabDarkTheme is TabTheme.Dark ? Color.ParseColor("#424242") : Color.ParseColor("#f7f7f7"));
        ...
        private void InviteFriendsButtonOnClick(object sender, EventArgs e)
        {
            try
            {
                var intent = new Intent(this, typeof(InviteMembersCommunityActivity));
        ...
        /*private void MAdapterOnItemClick(object sender, MembersAdapterClickEventArgs e)
        {
            try
            {
                ...
                if (ItemUser != null)
                {
                    ...
                    /*if (CommunityDataClass.IsOwner != null && CommunityDataClass.IsOwner.Value)
                    {
        ...
        private async Task LoadMembersAsync(string offset = "")
        {
            ...
            if (Methods.CheckConnectivity())
            {
                ...
                var (apiStatus, respond) = await CustomRequests.Community.GetCommunityMembersAsync(CommunityId, "10", offset);
        ...
        /*public void OnSelection(MaterialDialog dialog, View itemView, int position, string itemString)
        {
            try
            {
                ...
                {
                    PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => CustomRequests.Community.RemoveCommunityMembersAsync(CommunityId, ItemUser.UserId) });
                ...
                {
                    PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => CustomRequests.Community.RemoveCommunityMembersAsync(CommunityId, ItemUser.UserId), () => RequestsAsync.Global.BlockUserAsync(CommunityId, true) });
