...
namespace Facesofnaija.Activities.Communities.Communities.Settings
{
    ...
    public class CommunityPrivacyActivity : BaseActivity//, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private string CommunityId, JoinPrivacyId = "", TypeDialog = "", CommunityPrivacy = "";
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                SetTheme(AppSettings.SetTabDarkTheme is TabTheme.Dark ? Resource.Style.MyTheme_Dark : Resource.Style.MyTheme);
                ...
                if (id != "Data not available" && !string.IsNullOrEmpty(id)) CommunityId = id;
        ...
        private void InitComponent()
        {
            try
            {
                ...
                Methods.SetColorEditText(TxtJoinPrivacy, AppSettings.SetTabDarkTheme is TabTheme.Dark ? Color.White : Color.Black);
        ...
        private async void TxtCreateOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(CommunityPrivacy))
                {
                ...
                var (apiStatus, respond) = await CustomRequests.Community.UpdateCommunityDataAsync(CommunityId, dictionary);
                switch (apiStatus)
                {
                    case 200:
                        {
                                ...
                                case MessageObject result:
                                    {
                                        ...
                                        CommunityData.Privacy = CommunityPrivacy;
                                        CommunityData.JoinPrivacy = JoinPrivacyId;
                                        ...
                                        returnIntent?.PutExtra("communityItem", JsonConvert.SerializeObject(CommunityData));
        ...
        /*private void TxtJoinPrivacyOnTouch(object sender, View.TouchEventArgs e)
        {
            try
            {
                ...
                var dialogList = new MaterialDialog.Builder(this).Theme(AppSettings.SetTabDarkTheme is TabTheme.Dark ? MaterialDialogsTheme.Dark : MaterialDialogsTheme.Light);
        ...
        private void Get_Data_Community()
        {
            try
            {
                ...
                if (CommunityData != null)
                {
                    ...
                    CommunityPrivacy = CommunityData.Privacy;

                    switch (CommunityData.JoinPrivacy)
                    {
                        case "1":
                            JoinPrivacyId = "1";
                            TxtJoinPrivacy.Text = GetString(Resource.String.Lbl_No);
