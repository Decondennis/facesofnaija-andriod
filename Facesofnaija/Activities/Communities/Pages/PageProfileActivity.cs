...
using Facesofnaija.Activities.Communities.Pages.Settings;
...
namespace Facesofnaija.Activities.Communities.Pages
{
    ...
    public class PageProfileActivity : BaseActivity, IDialogListCallBack, IDialogInputCallBack, AppBarLayout.IOnOffsetChangedListener, IActivityResultCallback
    {
                    ...
                    if (result.IsSuccessful)
                    {
                        ...
                        if (!string.IsNullOrEmpty(filepath))
                        {
                            ...
                            if (GalleryController?.ImageType == "Cover")
                            {
                                ...
                                UpdateImagePage_Api(GalleryController?.ImageType, filepath);
                            }
