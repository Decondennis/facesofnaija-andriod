...
namespace Facesofnaija.Activities.Communities.Adapters
{
    public class SettingsAdapter : RecyclerView.Adapter
    {
        ...
        public SettingsAdapter(Activity context, string type, PageDataObject pageClass)
        {
            try
            {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                var itemView = LayoutInflater.From(parent.Context)?.Inflate(Resource.Layout.Style_SettingsView, parent, false);
        ...
        private void SetItemPage(PageDataObject pageData)
        {
            try
            {
