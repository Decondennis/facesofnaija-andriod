...
namespace Facesofnaija.Activities.CommonThings.Adapters
{
                    ...
                    case CommonThingsAdapterViewHolder holder:
                        {
                            ...
                            if (item != null)
                            {
                                GlideImageLoader.LoadImage(ActivityContext, item.UserData.Avatar, holder.Image, ImageStyle.FitCenter, ImagePlaceholders.DrawableUser);
