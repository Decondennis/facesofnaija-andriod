...
namespace Facesofnaija.Activities.SettingsPreferences.Adapters
{
        ...
        public MyInformationAdapter(Activity context)
        {
            try
            {
                ...
                MyInfoList.Add(new Classes.MyInformation
                {
                    ...
                    BgColor = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.White,
                ...
                MyInfoList.Add(new Classes.MyInformation
                {
                    ...
                    BgColor = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#f8f8ff"),
                ...
                MyInfoList.Add(new Classes.MyInformation
                {
                    ...
                    BgColor = WoWonderTools.IsTabDark() ? Color.ParseColor("#262626") : Color.ParseColor("#fbf1ff"),
                ...
                MyInfoList.Add(new Classes.MyInformation
                {
                    ...
                    BgColor = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.ParseColor("#f9fffa"),
                ...
                switch (AppSettings.ConnectivitySystem)
                {
                    case 1:
                        MyInfoList.Add(new Classes.MyInformation
                        {
                            ...
                            BgColor = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#f5fffd"),
                        ...
                        MyInfoList.Add(new Classes.MyInformation
                        {
                            ...
                            BgColor = WoWonderTools.IsTabDark() ? Color.ParseColor("#262626") : Color.ParseColor("#fff9f9"),
                    ...
                    default:
                        MyInfoList.Add(new Classes.MyInformation
                        {
                            ...
                            Color = Color.ParseColor("#FF9800"),
                            BgColor = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.ParseColor("#fff9f5"),
                            Icon = Resource.Drawable.ic_more_following,
                            Type = "friends",
                        });
                        break;
