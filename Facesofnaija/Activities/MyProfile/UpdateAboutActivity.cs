    ...
    public class UpdateAboutActivity : BaseActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                SetContentView(Resource.Layout.UpdateAboutLayout);
        ...
        private async void TxtSaveOnClick(object sender, EventArgs e)
        {
                        ...
                        case 200:
                            {
                                switch (respond)
                                {
                                    ...
                                    case MessageObject result:
                                        ...
                                        ProgressDialogHelper.ShowErrorToast(this, result.Message, MaskType.Clear, TimeSpan.FromSeconds(1));
                                        break;
                                }
            ...
            catch (Exception exception)
            {
                Methods.DisplayReportResultTrack(exception);
                //Show a Error image with a message
                ProgressDialogHelper.ShowErrorToast(this, exception.Message, MaskType.Clear, TimeSpan.FromSeconds(1));
                //ProgressDialogHelper.Dismiss(this);
            }
        }
    }
