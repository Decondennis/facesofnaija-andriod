    ...
    public class AdapterBind
    {
        ...
        public void HeaderPostBind(AdapterHolders.PostTopSectionViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                CircleGlideRequestBuilder.AddListener(new AdapterBind.GlideCustomRequestListener("GlobalCircle")).Override(70).Load(item.PostData.PostPrivacy == "4" ? "user_anonymous" : publisher.Avatar).CircleCrop().Into(holder.UserAvatar);
        ...
        public void SharedHeaderPostBind(AdapterHolders.PostTopSharedSectionViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                CircleGlideRequestBuilder.DontTransform_T();
                CircleGlideRequestBuilder.Downsample(DownsampleStrategy.CenterInside);
                CircleGlideRequestBuilder.AddListener(new AdapterBind.GlideCustomRequestListener("GlobalCircle")).Override(70).Load(itemPost.PostPrivacy == "4" ? "user_anonymous" : publisher.Avatar).CircleCrop().Into(holder.UserAvatar);
