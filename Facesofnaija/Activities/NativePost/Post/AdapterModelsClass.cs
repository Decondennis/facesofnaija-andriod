...
namespace Facesofnaija.Activities.NativePost.Post
{
    ...
    {
        Global, Event, Group, Community, Page, Popular, User, Saved, HashTag, SearchForPosts, Memories, Share, Boosted, Video, Live, Advertise
    }
    ...
    public class AdapterModelsClass
    {
        ...
        public CommunityPrivacyModelClass CommunityPrivacyModelClass { get; set; }
    ...
    public enum PostModelType
    {
        ...
        InfoUserBox = 63, InfoPageBox = 64, InfoGroupBox = 65, TikTokPost = 66, SuggestedPagesBox = 70, TwitterPost = 71, MultiImage5 = 72, MultiImage6 = 73, MultiImage7 = 74, MultiImage8 = 75, MultiImage9 = 76, MultiImage10 = 77, CommunitiesBox = 100, SuggestedCommunitiesBox = 101, InfoCommunityBox = 102
    }
    ...
    public class CommunityPrivacyModelClass
    {
        public CommunityDataObject CommunityClass { get; set; }
