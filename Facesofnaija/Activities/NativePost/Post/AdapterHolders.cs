...
// TODO: Replace with MediaPlayer - ExoPlayer not compatible with .NET 9
...
namespace Facesofnaija.Activities.NativePost.Post
{
    public class AdapterHolders
    {
        ...
        public class PostVideoSectionViewHolder : RecyclerView.ViewHolder, View.IOnClickListener /*, IVideoPlayerEventListener */ // TODO: Implement with MediaPlayer
        {
            public View MainView { get; private set; }
            ...
            // TODO: Replace with MediaPlayer views
            ...
            public PostVideoSectionViewHolder(View itemView, NativePostAdapter postAdapter) : base(itemView)
            {
                try
                {
                    ...
                    catch
                    {
                        ...
                        VideoProgressBar = new ProgressBar(itemView.Context);
                    }

                    // TODO: Restore when MediaPlayer implementation is ready
            ...
            public void OnPrePlay(object player)
            {
                try
                {
                    // ExoPlayer-specific implementation commented out
                    /*
            ...
            // TODO: Implement with MediaPlayer
            public void PlayVideo(object player)
            {
                try
                {
                    // ExoPlayer-specific implementation commented out
            ...
            // TODO: Implement with MediaPlayer
            public void ControlView_ProgressUpdate(object sender, object e)
            {
                try
                {
                    // ExoPlayer-specific implementation commented out
