...
namespace Facesofnaija.Activities.Movies
{
    public class MoviesCommentClickListener : Java.Lang.Object, IDialogListCallBack
    {
                    ...
                    try
                    {
                        switch (TypeClass)
                        {
                            case "Comment":
                                {
                                    //TypeClass
                                    // TODO: Restore when VideoViewerActivity has proper adapter
                                    /*
