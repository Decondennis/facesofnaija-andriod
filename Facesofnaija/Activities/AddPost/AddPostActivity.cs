...
namespace Facesofnaija.Activities.AddPost
{
    ...
    public class AddPostActivity : BaseActivity, IActivityResultCallback, SlidingPaneLayout.IPanelSlideListener, SlidingUpPanelLayout.IPanelSlideListener, IDialogListCallBack, IDialogInputCallBack, ITextWatcher, IOnFeelingClick, IOnDoingListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                InitBackPressed("AddPostActivity");
