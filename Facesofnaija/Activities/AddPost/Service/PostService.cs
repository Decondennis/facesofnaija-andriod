...
namespace Facesofnaija.Activities.AddPost.Service
{
    ...
    public class PostService : Android.App.Service
    {
        ...
        public async Task AddPost()
        {
            try
            {
                ...
                {
                    ToastUtils.ShowToast(Application.Context, GetText(Resource.String.Lbl_VideoUploadWithProcessed), ToastLength.Short);
                }
                else
                {
                    RemoveNotification();
