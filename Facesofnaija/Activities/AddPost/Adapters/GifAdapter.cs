                    ...
                    case GifAdapterViewHolder holder:
                        {
                            ...
                            {
                                case false:
                                    Glide.With(ActivityContext?.BaseContext).Load(item.Images.FixedHeightDownsampled.Url).Apply(new RequestOptions().Placeholder(Resource.Drawable.ImagePlacholder).Override(AppSettings.ImagePostSize)).Into(holder.Image);
                                    break;
                            }
