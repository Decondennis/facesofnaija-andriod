                                    ...
                                    default:
                                        {
                                            ...
                                            else
                                            {
                                                switch (item.TypeAttachment)
                                                {
                                                    ...
                                                    default:
                                                        Glide.With(ActivityContext?.BaseContext).Load(new File(item.FileUrl)).Apply(new RequestOptions().Placeholder(Resource.Drawable.Blue_Color).Error(Resource.Drawable.Blue_Color)).Into(holder.Image);
                                                        break;
                                                }
                                            }
