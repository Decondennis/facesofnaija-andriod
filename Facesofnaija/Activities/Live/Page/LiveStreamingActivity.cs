...
using Facesofnaija.Activities.Live.Ui;
using Facesofnaija.Activities.NativePost.Post;
using Facesofnaija.Activities.NativePost.Share;
...
namespace Facesofnaija.Activities.Live.Page
{
                    ...
                    case true:
                        {
                            if (PostObject != null)
                            {
                                ...
                                StreamRateLevel.SetImageURI(Android.Net.Uri.Parse(PostObject.Publisher.Avatar));
                    ...
                    default:
                        {
                            if (LiveStreamViewerObject != null)
                            {
                                ...
                                StreamRateLevel.SetImageURI(Android.Net.Uri.Parse(LiveStreamViewerObject.Publisher.Avatar));
