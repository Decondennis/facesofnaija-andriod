    ...
    public class JobNearbyAdapter : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider
    {
                ...
                if (viewHolder is JobNearbyAdapterViewHolder holder)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        else
                        {
                            ...
                            Glide.With(ActivityContext?.BaseContext).Load(photoUri).Apply(new RequestOptions()).Into(holder.JobImage);
                        }
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                var itemView = LayoutInflater.From(parent.Context)?.Inflate(Resource.Layout.Style_PopularJobView, parent, false);
            ...
            try
            {
                ...
                switch (holder)
                {
                    case JobNearbyAdapterViewHolder viewHolder:
                        Glide.With(ActivityContext?.BaseContext).Clear(viewHolder.JobImage);
                        break;
                }
