...
using Facesofnaija.Activities.Jobs.Adapters;
...
namespace Facesofnaija.Activities.Jobs
{
    ...
    public class CreateJobActivity : BaseActivity, View.IOnFocusChangeListener, IDialogListCallBack, IActivityResultCallback
    {
