...
namespace Facesofnaija.CustomApi
{
    /// <summary>
    ...
    public class CustomApiModel
    {
        ...
        public CustomApiModel()
        {
            try
            {
                InitializeWoWonder.Initialize(AppSettings.TripleDesAppServiceProvider, Application.Context.PackageName, AppSettings.TurnSecurityProtocolType3072On, AppSettings.SetApisReportMode);
