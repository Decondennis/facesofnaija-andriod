...
namespace Facesofnaija.Helpers.Ads
{
...
#pragma warning restore 618
        ...
        public static InterstitialAd InitInterstitial(Activity activity)
        {
            try
            {
                switch (WoWonderTools.GetStatusAds() && AppSettings.ShowFbInterstitialAds)
                {
...
#pragma warning restore 618
        ...
        public static RewardedVideoAd InitRewardVideo(Activity activity)
        {
            try
            {
                switch (WoWonderTools.GetStatusAds() && AppSettings.ShowFbRewardVideoAds)
                {
