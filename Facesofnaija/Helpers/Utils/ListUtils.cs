...
namespace Facesofnaija.Helpers.Utils
{
    public static class ListUtils
    {
        ...
        public static ObservableCollection<CommunityDataObject> MyCommunityList = new ObservableCollection<CommunityDataObject>();
        ...
        public static ObservableCollection<CommunityDataObject> SuggestedCommunityList = new ObservableCollection<CommunityDataObject>();
