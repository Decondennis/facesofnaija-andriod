...
namespace Facesofnaija.Library.Anjo
{
            ...
            try
            {
                ...
                if (MReactButton.Text == ReactConstants.Like)
                {
                    ...
                    if (MDefaultReaction.GetReactType() == ReactConstants.Default)
                    {
                        ...
                        icon?.SetTint(Color.ParseColor(WoWonderTools.IsTabDark() ? "#ffffff" : "#9A9898"));
                    }
            ...
            try
            {
                ...
                if (MReactButton.Text == ReactConstants.Like)
                {
                    icon = AppSettings.PostButton switch
                    {
                        ...
                        PostButtonSystem.ReactionDefault => AppCompatResources.GetDrawable(Context, react.GetReactType() == ReactConstants.Default ? Resource.Drawable.icon_post_like_vector : Resource.Drawable.emoji_like), //ic_action_like,
                        PostButtonSystem.ReactionSubShine => AppCompatResources.GetDrawable(Context, react.GetReactType() == ReactConstants.Default ? Resource.Drawable.icon_post_like_vector : Resource.Drawable.like), //ic_action_like
                        _ => icon
                    };

                    //if (AppSettings.AppMode == AppMode.Instagram)
                    //{
                    //    icon = AppCompatResources.GetDrawable(Context, react.GetReactType() == ReactConstants.Default ? Resource.Drawable.icon_heart_post_vector : Resource.Drawable.emoji_love);
                    //}
                ...
                else if (MReactButton.Text == ReactConstants.Love)
                {
                    icon = AppSettings.PostButton switch
                    {
                        PostButtonSystem.ReactionDefault => AppCompatResources.GetDrawable(Context, Resource.Drawable.emoji_love),
                        PostButtonSystem.ReactionSubShine => AppCompatResources.GetDrawable(Context, Resource.Drawable.love),
                        _ => icon
                    };
                ...
                else if (MReactButton.Text == ReactConstants.HaHa)
                {
                    icon = AppSettings.PostButton switch
                    {
                        PostButtonSystem.ReactionDefault => AppCompatResources.GetDrawable(Context, Resource.Drawable.emoji_haha),
                        PostButtonSystem.ReactionSubShine => AppCompatResources.GetDrawable(Context, Resource.Drawable.haha),
                        _ => icon
                    };
                ...
                else if (MReactButton.Text == ReactConstants.Wow)
                {
                    icon = AppSettings.PostButton switch
                    {
                        PostButtonSystem.ReactionDefault => AppCompatResources.GetDrawable(Context, Resource.Drawable.emoji_wow),
                        PostButtonSystem.ReactionSubShine => AppCompatResources.GetDrawable(Context, Resource.Drawable.wow),
                        _ => icon
                    };
                ...
                else if (MReactButton.Text == ReactConstants.Sad)
                {
                    icon = AppSettings.PostButton switch
                    {
                        PostButtonSystem.ReactionDefault => AppCompatResources.GetDrawable(Context, Resource.Drawable.emoji_sad),
                        PostButtonSystem.ReactionSubShine => AppCompatResources.GetDrawable(Context, Resource.Drawable.sad),
                        _ => icon
                    };
                ...
                else if (MReactButton.Text == ReactConstants.Angry)
                {
                    icon = AppSettings.PostButton switch
                    {
                        PostButtonSystem.ReactionDefault => AppCompatResources.GetDrawable(Context, Resource.Drawable.emoji_angry),
                        PostButtonSystem.ReactionSubShine => AppCompatResources.GetDrawable(Context, Resource.Drawable.angry),
                        _ => icon
                    };
                ...
                else
                {
                    ...
                    //if (AppSettings.AppMode == AppMode.Instagram)
                    //{
                    //    icon = AppCompatResources.GetDrawable(Context, Resource.Drawable.icon_heart_post_vector);
                    //}
